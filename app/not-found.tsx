  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <div className="text-8xl font-extrabold bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent mb-4">404</div>
        ...
        <div className="flex items-center justify-center gap-3">
          <Link href="/discover" className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-semibold rounded-xl shadow-lg shadow-blue-500/25">Go to Dashboard</Link>
