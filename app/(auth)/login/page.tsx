    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-8">
          <Image src="/images/logo.png" alt="Reachly" width={56} height={56} className="w-14 h-14 rounded-2xl mb-4 shadow-lg shadow-blue-500/25 mx-auto" />
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-8">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-[#1e293b]">Welcome back</h2>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-label="Password"
                  className="w-full pl-10 pr-10 py-2.5 border border-slate-200 rounded-xl text-sm text-[#1e293b] placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200"
                />
                <button
                  type="button"
